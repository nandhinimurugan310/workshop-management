...
class VendorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $vendorIdWithPrefix = 'SUP' . $vendorIdFormatted;
    ...
    public function destroy($id)
    {
        ...
        if ($vendor) {
            $vendor->delete();
            return redirect()->route('vendor.index')->with('success', 'Supplier deleted successfully.');
        }

        return redirect()->route('vendor.index')->with('error', 'Supplier not found.');
    }
}
